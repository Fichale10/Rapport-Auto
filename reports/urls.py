...
urlpatterns = [
    ...
    path('analytics/dr2/',                        login_required(views.analytics_dr2), name='analytics_dr2'),
    path('analytics/dr2/import/',                 login_required(views.analytics_dr2_import), name='analytics_dr2_import'),
    path('analytics/dr2/export/',                 login_required(views.analytics_dr2_export), name='analytics_dr2_export'),
    ...
    path('reporting/dr2-daily/dashboard/',        login_required(views.dr2_dashboard_view), name='dr2_dashboard'),
    path('reporting/dr2-daily/export-gdi/',       login_required(views.dr2_gdi_export),     name='dr2_gdi_export'),
    path('reporting/dr2-daily/export-reunion/',   login_required(views.dr2_reunion_export), name='dr2_reunion_export'),
    ...
    path('site-info/architecture-globale/',       login_required(views.sites_architecture_global), name='sites_architecture_global'),
