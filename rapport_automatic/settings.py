"""
Django settings for rapport_automatic project.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-+qtlpc^5uz#up=$(o0*mp)so4#56!m@4g3*9f*sv7th#b#@l+r'
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', 'False') == 'True'

# Autorise toutes les IPs du réseau local (intranet)
